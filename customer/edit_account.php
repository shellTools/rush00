...
<?php 
	if(isset($_POST['update'])){
		...
		$c_address = $_POST['c_address'];
		 ...
		 $update_c = "update customers set customer_name='$c_name', customer_email='$c_email', customer_pass='$c_pass',customer_address='$c_address' where customer_id='$customer_id'";
